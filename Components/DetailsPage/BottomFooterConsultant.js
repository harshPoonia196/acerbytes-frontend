    ...
    <>
      ...
      >
        <Container
          maxWidth="md"
          sx={{
            px: { xs: "0 !important", evmd: "1rem !important" },
            py: "0 !important",
          }}
        >
          <Box
            sx={{
              ...
              alignItems: "start",
              gap: "0px",
              borderTop: propertyData?.isActiveAd
          ...
          >
            <Box>
              <Typography variant="body2" sx={{ marginBottom: "5px" }}>
                {`${capitalLizeName(
                  propertyData?.overview?.builder || "builder"
                )}  | ${capitalLizeName(
                  propertyData?.overview?.projectName || "projectName"
            ...
            <Box sx={{ display: "flex" }}>
              <Avatar
                src={propertyData?.brokerDetais?.profilePicture}
                sx={{
                  height: { xs: 24, evmd: 40 },
                  width: { xs: 24, evmd: 40 },
                  fontSize: { xs: "0.75rem", evmd: "1rem" },
                }}
              ></Avatar>
              <Box
                sx={{
                ...
                <Box sx={{ display: "flex" }}>
                  ...
                  >
                    ...
                    <div>
                      <Typography
                        variant="body2"
                        sx={{ lineHeight: "1.3", marginTop: "5px" }}
                      >
                        {SinglePropertyId?.expired_at
                          ? formatDateAndDaysRemaining(
                              SinglePropertyId?.expired_at,
                  ...
                  >
                    ...
                    >
                      ...
                      />{" "}
                      {propertyData?.isActiveAd ? "Extend" : "Activate link"}{" "}
                    </MenuItem>
                    {propertyData?.isActiveAd ? (
                      <MenuItem onClick={() => copyToClipboard(propertyUrl)}>
                        <ShareIcon
