            ...
            <Box>
                <Box sx={{display:'flex', justifyContent:'space-between'}}>
                   <Box>
                        ...
                        <Typography sx={{}} variant="body2">2 months ago</Typography>
                   </Box>
                   <Box>
                        <IconButton size='small'>
                            <ThumbUpIcon size='small'/>
                        </IconButton>
                        <Typography sx={{ml:'0.4rem', display:'inline'}} variant="body2">Helpful?</Typography>
                    </Box>
                </Box>
                <Box sx={{mt:'0.4rem'}}>
                        <Rating
                    ...
                    />
                <Typography variant="p" sx={{ml:'0.3rem'}}>
                ...
                <Card sx={{borderLeft:'2px solid gray',mt:'0.5rem', p:2}}>
                    ...
                    <Typography variant="p" sx={{}}>Let nam vitae possimus dignissimos recusandae esse. Aperiam, quia!
                    </Typography>
                </Card>
            </Box>
        </Card>
