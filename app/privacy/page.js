      ...
      <Container maxWidth="md" sx={{ mx: "auto" }}>
        <Paper sx={{ p: 2 }} square={false} elevation={2}>
          ...
          <Typography sx={{ my: 1 }} variant="subtitle2">
            ...
            Companies Act, 1956 (“Company”). The Company is engaged in the
            business of facilitating owners, tenants, buyers and sellers to
            explore and identify all kinds of immovable properties including
            lands, buildings, factories, houses, flats, and other residential,
            commercial, and industrial plots and properties and enabling them to
            carry on transaction of purchase, sale, licensing, leasing, hiring,
            renting or otherwise relating to movable and immovable properties
            and other related services (“Services”).
            <br />
            This Privacy Policy (“Privacy Policy”) sets out the privacy
            practices of the Company with respect to the entire content of the
            Website.
            <br />
            ...
            terms of use on an online portal of the Company. We request you to
            go through this Privacy Policy and the Terms of Use carefully before
            ...
            “user”, as applicable mean the person who accesses, uses and/or
            participates in the Website in any manner or capacity.
            <br />
            The protection and security of your personal information is our top
            priority and we have taken all necessary and reasonable measures to
